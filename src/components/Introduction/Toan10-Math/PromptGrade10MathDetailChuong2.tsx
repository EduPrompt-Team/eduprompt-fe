...
const PromptGrade10MathDetailChuong2: React.FC = () => {
  ...
  const mathPrompts = [
    {
      ...
      favorites: 12,
      views: 156,
      tags: ["Bất Phương Trình", "Bậc Nhất", "2 Ẩn"],
      difficulty: "Cơ bản",
      grade: "10"
    },
    {
      id: 2,
      title: "Hệ Bất Phương Trình Bậc Nhất 2 Ẩn",
      description: "Các công thức và phương pháp giải bài tập hình học không gian lớp 10",
      image: new URL('../../assets/Image/Toan10.png', import.meta.url).href,
      downloads: 38,
      favorites: 8,
      views: 134,
      tags: ["Hệ Bất Phương Trình", "Bậc Nhất", "2 Ẩn"],
    ...
    },
    {
      ...
      favorites: 15,
      views: 189,
      tags: ["Bài Tập Cuối Chương", "Bất Phương Trình", "Bậc Nhất", "2 Ẩn"],
      difficulty: "Cơ bản",
      grade: "10"
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">Học Kỳ 1 - Chương 2</h2>
...
export default PromptGrade10MathDetailChuong2